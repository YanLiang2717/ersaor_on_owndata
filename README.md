...
|------|---------|----------|
| PCD+TF→ROS Bag | Converts point clouds with TF data | [`ERASOR/scripts/semantickitti2bag/to_ros_bag.py`]|
| ROS Bag→ERASOR Bag | Formats bag for ERASOR algorithm | [`ERASOR/scripts/semantickitti2bag/to_erasor_data.py` ]|
## Citation 
